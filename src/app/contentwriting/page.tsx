    ...
    <div className="min-h-screen mt-20 bg-white px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center justify-center mb-6">
        <div className="flex items-center gap-2">
          <PencilLine className="text-[#2E8AE0]" size={28} />
          <h1 className="text-2xl font-bold text-[#2E8AE0]">Content Writing</h1>
        </div>
      ...
      <p className="mt-6 text-gray-700 leading-relaxed text-sm sm:text-base max-w-3xl">
        We believe in delivering more than just designs – we deliver results.
        Our team works closely with you to understand your vision, and then
        turns it into reality with creative, functional, and responsive
