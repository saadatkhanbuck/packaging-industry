    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <div className="flex items-center space-x-2 text-sm">
            <svg className="w-10 h-10 text-[#124576]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#f8f6f3] text-black px-4 pb-4 font-semibold space-y-2">
          {navItems.map((item, idx) => (
            <div key={idx}>
              <button
                onClick={() =>
